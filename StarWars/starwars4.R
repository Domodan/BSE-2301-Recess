...
#Also, at some point we may wanna use the document term matrix instead
#So, let's head straight to it

#Creating a document term matrix for the characters

characters_dtm <- DocumentTermMatrix(starwars4_characters)
inspect(characters_dtm[1:3,1:3])
